<style>
    ...
    header {
        ...
        position: sticky;
        top: 0;
        z-index: 999; /* Slightly lower than sidebar */
    }
    ...
    .logo { height: 50px; width: auto; border-radius: 5px; }

    /* CHANGED: Used a class instead of generic 'nav ul' */
    .main-nav-list {
        list-style: none;
        display: flex; 
        margin: 0;
...
<header>
    <div class="header-container">
        ...
        <nav>
            <ul class="main-nav-list"> <li><a href="<?php echo $base_url; ?>index.php">Home</a></li>
